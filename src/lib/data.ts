...
export const servers: Server[] = [
  ...
  { id: 'srv-3', name: 'Analytics Engine', ipAddress: '192.168.1.103', port: 9090, status: 'offline', cpuUsage: 0, memoryUsage: 0, storageUsage: 95, metrics: generateMetrics().map(m => ({...m, cpu: 0, memory: 0, network: 0})), alerts: ['ALERT: Server is unreachable. Ping failed. Last seen 1 hour ago.'] },
